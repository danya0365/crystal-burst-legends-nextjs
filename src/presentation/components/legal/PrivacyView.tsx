...
import { PrivacyViewModel } from "@/src/presentation/presenters/legal/LegalPresenter";
import { usePrivacyPresenter } from "@/src/presentation/presenters/legal/useLegalPresenter";
...
export function PrivacyView({ initialViewModel }: PrivacyViewProps) {
  const { viewModel, loading, error } = usePrivacyPresenter(initialViewModel);
